...
- **Never add `Co-Authored-By` trailers with AI model names or emails** (e.g. `Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>`) to any commit message. Commits are authored solely by the human committer.
