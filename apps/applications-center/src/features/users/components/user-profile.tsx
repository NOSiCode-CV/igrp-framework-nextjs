...
import { useCurrentUser, useRemoveUserRole, useUserRoles } from '@/features/users/use-users';
  ...
  return (
    <div className='flex flex-col gap-10 animate-fade-in'>
      ...
      <div className='flex flex-col gap-6'>
        <IGRPCardPrimitive>
          <IGRPCardHeaderPrimitive>
            <IGRPCardTitlePrimitive>Informações do Utilizador</IGRPCardTitlePrimitive>
            <IGRPCardDescriptionPrimitive>Informação Básica</IGRPCardDescriptionPrimitive>
          </IGRPCardHeaderPrimitive>
          <IGRPCardContentPrimitive>
            <dl className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-sm gap-4'>
              ...
              <div className='flex flex-col gap-3'>
                <dt className='font-medium text-muted-foreground'>Assinatura</dt>
                <dd>
                  {/* {getSignature?.link ? (
                          <Image
