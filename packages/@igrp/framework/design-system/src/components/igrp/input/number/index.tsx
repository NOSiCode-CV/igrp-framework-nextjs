      ...
      <div className='*:not-first:mt-2'>
        ...
        >
          <Input
            ...
            className='bg-background text-foreground flex-1 px-3 py-2 tabular-nums outline-none border-none focus-visible:outline-none focus-visible:ring-ring/0 focus-visible:ring-0'
            disabled={disabled}
            readOnly={readOnly}
          ...
          {!readOnly && (
            <div className='flex h-full flex-col border-l'>
              <IGRPButton
                ...
                className='bg-background text-muted-foreground/80 hover:bg-accent hover:text-foreground flex h-1/2 w-8 items-center justify-center border-b text-xs transition-colors'
              ...
              <IGRPButton
                ...
                className='bg-background text-muted-foreground/80 hover:bg-accent hover:text-foreground flex h-1/2 w-8 items-center justify-center text-xs transition-colors'
