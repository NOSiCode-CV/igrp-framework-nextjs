...
const INPUT_GROUP_ADDON_INTERACTIVE =
  "button, a[href], input, select, textarea, label, [role='button'], [contenteditable='true'], [tabindex]:not([tabindex='-1'])"
  ...
  return (
    <div
      ...
      onClick={(e) => {
        ...
        const interactive = target.closest(INPUT_GROUP_ADDON_INTERACTIVE)
