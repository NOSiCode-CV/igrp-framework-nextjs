...
export const IGRPColors = {
  ...
  soft: {
    primary: {
      bg: "bg-primary/5",
      bgStatic: "bg-primary/5",
      text: "text-primary",
      border: "border-transparent",
      bgForeground: "bg-primary",
      badge: "text-primary bg-primary/5 border-primary/10",
      textCard: "text-primary",
      bgCardIcon: "bg-primary",
      borderCard: "border-primary",
      alert: "text-primary bg-primary/5 border-primary/20",
    },
    success: {
      bg: "bg-success/5",
      bgStatic: "bg-success/5",
      text: "text-success",
      border: "border-transparent",
      bgForeground: "bg-success",
      badge: "text-success bg-success/5 border-success/10",
      textCard: "text-success",
      bgCardIcon: "bg-success",
      borderCard: "border-success",
      alert: "text-success bg-success/5 border-success/20",
    },
    destructive: {
      bg: "bg-destructive/5",
      bgStatic: "bg-destructive/5",
      text: "text-destructive",
      border: "border-transparent",
      bgForeground: "bg-destructive",
      badge: "text-destructive bg-destructive/5 border-destructive/10",
      textCard: "text-destructive",
      bgCardIcon: "bg-destructive",
      borderCard: "border-destructive",
      alert: "text-destructive bg-destructive/5 border-destructive/20",
    },
    warning: {
      bg: "bg-warning/5",
      bgStatic: "bg-warning/5",
      text: "text-warning",
      border: "border-transparent",
      bgForeground: "bg-warning",
      badge: "text-warning bg-warning/5 border-warning/10",
      textCard: "text-warning",
      bgCardIcon: "bg-warning",
      borderCard: "border-warning",
      alert: "text-warning bg-warning/5 border-warning/20",
    },
    info: {
      bg: "bg-info/5",
      bgStatic: "bg-info/5",
      ...
      border: "border-transparent",
      bgForeground: "bg-info",
      badge: "text-info bg-info/5 border-info/10",
      textCard: "text-info",
      bgCardIcon: "bg-info",
      borderCard: "border-info",
      alert: "text-info bg-info/5 border-info/20",
    },
    secondary: {
      bg: "bg-muted",
      bgStatic: "bg-muted",
    ...
    indigo: {
      bg: "bg-indigo/5",
      bgStatic: "bg-indigo/5",
      text: "text-indigo",
      border: "border-transparent",
      bgForeground: "bg-indigo",
      badge: "text-indigo bg-indigo/5 border-indigo/10",
      textCard: "text-indigo",
      bgCardIcon: "bg-indigo",
      borderCard: "border-indigo",
      alert: "text-indigo bg-indigo/5 border-indigo/20",
    },
  },
}
