export const IGRPColors = {
  ...
  solid: {
    primary: {
      ...
      bgBadge: 'bg-foreground',
      borderBadge: 'border-primary-foreground',
      textCard: 'text-primary',
    ...
    indigo: {
      ...
      textBadge: 'text-purple-100',
      bgBadge: 'bg-purple-800',
