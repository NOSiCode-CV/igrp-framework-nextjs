...
export default function Deliverymodalform({
  isOpen,
  setIsOpen,
  initialData,
}: {
  isOpen: boolean;
  setIsOpen: (prompt: boolean) => void;
  initialData?: any;
}) {
  ...
  return (
    <div className={cn('component')}>
      <IGRPModalDialog onOpenChange={setIsOpen} open={isOpen}>
        <IGRPModalDialogContent className={cn('col-span-5')}>
          <IGRPModalDialogHeader>
            <IGRPHeadline
              name={`modal_headline`}
              variant={`h5`}
          ...
          <div className={cn(' relative')}>
            ...
            >
              <>
                <IGRPCard name={`basic_information_card`} className={cn('shadow-sm')}>
                  <IGRPCardHeader
          ...
          <IGRPModalDialogFooter className={cn('sm:flex justify-end')}>
            <IGRPButton
            ...
            >
              ...
              {!isSubmitting && <p className={cn()}>Salvar Entrega</p>}
            </IGRPButton>
          </IGRPModalDialogFooter>
        </IGRPModalDialogContent>
      </IGRPModalDialog>
