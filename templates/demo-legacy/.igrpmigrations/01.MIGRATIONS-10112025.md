...
steps:
  - type: file.write
    ...
    mode: replace
    from: payload/01/middleware.ts
  - type: file.write
    path: src/actions/igrp/layout.ts
    mode: replace
    from: payload/01/actions/igrp/layout.ts
  - type: file.write
    path: src/app/(igrp)/layout.tsx
    mode: replace
    from: "payload/01/app/(igrp)/layout.tsx"
  - type: file.write
    path: src/igrp.template.config.ts
    mode: replace
    from: payload/01/igrp.template.config.ts
  - type: file.create
    path: src/app/not-found.tsx
    from: payload/01/app/not-found.tsx
  - type: file.create
    path: "src/app/[...not-found]/page.tsx"
    from: "payload/01/app/[...not-found]/page.tsx"
---
