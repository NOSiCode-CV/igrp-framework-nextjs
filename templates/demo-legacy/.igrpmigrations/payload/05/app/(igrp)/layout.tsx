...
export default async function IGRPRootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  const currentPath = headersList.get("x-pathname") || headersList.get("x-next-url") || headersList.get("referer") || "";
